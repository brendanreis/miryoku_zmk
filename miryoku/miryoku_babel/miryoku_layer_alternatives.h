...
U_MT(LGUI, Q),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_ST(LSHFT, F),    &kp G,             &kp H,             U_ST(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, M),     \
...
U_MT(LGUI, Y),     U_MT(LALT, I),     U_MT(LCTRL, E),    U_ST(LSHFT, A),    &kp DOT,           &kp D,             U_ST(LSHFT, S),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MT(LGUI, B),     \
...
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_ST(LSHFT, T),    &kp D,             &kp H,             U_ST(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
...
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_ST(LSHFT, T),    &kp G,             &kp M,             U_ST(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_ST(LSHFT, T),    &kp G,             &kp K,             U_ST(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
...
U_MT(LGUI, A),     U_MT(LALT, O),     U_MT(LCTRL, E),    U_ST(LSHFT, U),    &kp I,             &kp D,             U_ST(LSHFT, H),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MT(LGUI, S),     \
...
U_MT(LGUI, S),     U_MT(LALT, H),     U_MT(LCTRL, N),    U_ST(LSHFT, T),    &kp COMMA,         &kp DOT,           U_ST(LSHFT, A),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, H),    U_ST(LSHFT, T),    &kp G,             &kp Y,             U_ST(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_ST(LSHFT, F),    &kp G,             &kp H,             U_ST(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
