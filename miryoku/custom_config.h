...
U_MT_L(LCTRL, N),     U_MT_L(LALT, R),     U_MT_L(LGUI, T),    &kp &s_bspc,    &kp G,             &kp Y,             U_LT(U_FUN, H),    U_MT_R(LGUI, A),    U_MT_R(LALT, E),     U_MT_R(LCTRL, I),     \
U_LT(U_BUTTON, Q), U_MT_L(RALT, X),     &kp M,             &kp C,             &kp V,             &kp K,             &kp P,             &kp COMMA,         U_MT_R(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  &kp LSHFT, U_LT(U_NUM, DEL),  U_NP,              U_NP
